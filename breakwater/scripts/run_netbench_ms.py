...
header = "num_threads,offered_load,throughput,cpu_bound_req_throughput,"\
         "mem_bound_req_throughput,lock_bound_req_throughput,"\
         "goodput,cpu_bound_req_goodput,mem_bound_req_goodput,lock_bound_req_goodput,"\
         "min,mean,p50,cpu_bound_req_p50,"\
         "mem_bound_req_p50,lock_bound_req_p50,p90,cpu_bound_req_p90,"\
         "mem_bound_req_p90,lock_bound_req_p90,p99,"\
         "cpu_bound_req_p99,mem_bound_req_p99,lock_bound_req_p99,p999,p9999,max,reject_min,"\
...
for i in range(NUM_SERVERS):
    header += "server{0}:cpu_bound_req_throughput,server{0}:mem_bound_req_throughput,"\
               "server{0}:lock_bound_req_throughput,"\
               "server{0}:cpu_bound_req_goodput,server{0}:mem_bound_req_goodput,"\
               "server{0}:lock_bound_req_goodput,"\
