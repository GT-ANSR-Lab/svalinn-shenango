...
FILES_TO_REPLACE = [
    # {
    #     "src": "../src/pcc_server.c",
    #     "dst": "breakwater/src/pcc_server.c",
    # },
]
...
for offered_load in OFFERED_LOADS:
    ...
    cmd = " cd ~/{} && sudo ./breakwater/apps/netbench/build/netbench {} server.config"\
...
header = "num_clients,offered_load,throughput,cpu_bound_req_throughput,mem_bound_req_throughput,goodput,cpu,membw,power"\
